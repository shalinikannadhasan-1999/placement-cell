...
div class="hero">
        ...
        <input type="text" class="inputf" placeholder="company id" required>
...
<button type="submit"  class="submitbtn"><a href="companydetails.html" >log in</a></button>
                </form>
    ...
    <button type="submit"  class="submitbtn"><a href="companydetails.html"> sign up</a></button>
                    </form>
