...
<div class="hero">
        ...
        <input type="text" class="inputf" placeholder="Student id" required>
...
<button type="submit"  class="submitbtn"><a href="studentdetails.html" >log in</a></button>
                </form>
    ...
    <button type="submit"  class="submitbtn"><a href="studentdetails.html"> sign up</a></button>
                    </form>
