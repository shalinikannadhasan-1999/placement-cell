...
<ul class="sec"> 
    ...
    <li><a href=" studentlogin.html"><input type ="submit" value="Student"></a></li> 
    <li><a href="companylogin.html"><input type ="submit" value="Company"></a></li> 
    <li><a href="adminlogin.html"><input type ="submit" value="Admin"></a></li> 
